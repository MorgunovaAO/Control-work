...
## Описание программы CreatingStringArray
...
* CreateArray (создание массива строк - с типом данных string); 

* ShowArray (вывод в консоли первоначального массива, созданного пользователем); 

* ShowNewArray (вывод в консоли преобразованного массива: длина каждой строки меньше или равна 3 символам). 
